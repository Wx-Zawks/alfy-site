...
export const products: Product[] = [
  ...
  { id: '8', name: '界面与基层配套', slug: 'interface-system', category: 'support', categoryName: '涂料配套', summary: '根据基材状态提供粘结、找平和界面处理支持。', image: '/images/heated-block.jpg', features: ['基层处理', '系统配套', '施工协同'] }
]
