...
export const applicationScenes: ApplicationScene[] = [
  ...
  { key: 'communication', name: '通信机房', slogan: '为关键设备构筑热防线', summary: '面向机房、基站与通信设备提供轻质隔热解决方案。', image: '/images/launch-2.jpg' },
  { key: 'defense', name: '国防军工', slogan: '严苛环境下的可靠隔热', summary: '围绕特种装备与复杂工况开展材料及复合体系验证。', image: '/images/launch-3.jpg' }
]
