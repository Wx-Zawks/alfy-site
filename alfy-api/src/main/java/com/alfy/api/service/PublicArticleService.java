...
public class PublicArticleService {
    ...
    public ArticleDetailResponse getArticle(String identifier) {
        ...
        Map<Long, String> urlByMediaId = media.stream().collect(Collectors.toMap(
                ArticleMediaResponse::id,
                ArticleMediaResponse::url,
                (first, ignored) -> first
        ));
    ...
    private String replaceInlineMediaUrls(
            String contentHtml, Map<String, String> urlByStorageKey, Map<Long, String> urlByMediaId) {
        ...
        for (Map.Entry<Long, String> entry : urlByMediaId.entrySet()) {
            String placeholder = "alfy-media:" + entry.getKey();
            result = result.replace("src=\"" + placeholder + "\"", "src=\"" + entry.getValue() + "\"")
                    .replace("src='" + placeholder + "'", "src='" + entry.getValue() + "'");
        }
        return result;
    }
